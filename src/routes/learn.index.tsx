...
const TOPICS = [
  {
    ...
    desc: "Shares, prices and probabilities — the basics.",
  },
  {
    to: "/learn/how-to-trade",
    icon: TrendingUp,
    title: "How to place your first trade",
    desc: "A step-by-step walkthrough.",
  },
  {
    to: "/learn/risk",
    icon: AlertTriangle,
    title: "Risk management",
    desc: "Position sizing, never trade money you can't afford to lose.",
  },
  {
    to: "/learn/slippage",
    icon: Activity,
    title: "Slippage & price impact",
    desc: "Why your trade moves the price.",
  },
  {
    to: "/learn/examples",
    icon: Lightbulb,
    title: "Worked examples",
    desc: "Real scenarios from Kenyan elections, sports and finance.",
  },
  {
    to: "/learn/disclaimer",
    icon: Shield,
    title: "Disclaimer",
    desc: "Important things to know before you trade.",
  },
  {
    to: "/learn/about",
    icon: Info,
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
      ...
      <div className="mt-6 rounded-xl border border-warning/30 bg-warning/10 p-4 text-sm text-warning">
        <strong>You can lose money.</strong> Prediction market trades are real-money bets on
        uncertain events. Only trade with funds you can afford to lose.
      </div>
        ...
        {TOPICS.map((t) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-3 font-semibold group-hover:text-primary transition">
                {t.title}
              </div>
